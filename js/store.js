...
export function defaultUI() {
  return {
    ...
    shopOpen: 1,       // список покупок на главном развёрнут
    shopH: 0,          // высота ленты покупок: 0 короткая, 1 средняя, 2 длинная
    shopWide: 0,       // на широком экране — во всю ширину
    shopOften: [],     // что уже покупали: подсказки в один тап
    shopGrp: 0,        // список по магазинам
